...
// Task 4
let raiseToDegree = function(value, power) {
...
let baseValue =  promptToEnterInteger('baseValue');
let powerValue = promptToEnterInteger('powerValue');
    
let result = raiseToDegree(baseValue, powerValue);
...
let minimumValue = findMin(12, 14, 4, -4, 0.2);
